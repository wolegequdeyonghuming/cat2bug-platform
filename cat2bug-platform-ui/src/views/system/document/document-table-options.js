...
export const DocumentTableColumnDefaults = [
  ...
  { key: 'updateBy', prop: 'updateByName', fixed: false, visible: true, align: 'center', width: 180 },
  { key: 'update-time', prop: 'updateTime', fixed: false, visible: true, align: 'center', width: 240 }
]
