...
export const CaseTableColumnDefaults = [
  { key: 'id', prop: 'caseNum', fixed: true, visible: true, align: 'center', width: 120 },
  { key: 'case.name', prop: 'caseName', fixed: true, visible: true, align: 'left', minWidth: 240, required: true },
  { key: 'module', prop: 'moduleName', fixed: false, visible: true, align: 'left', minWidth: 140, required: true },
  { key: 'level', prop: 'caseLevel', fixed: false, visible: true, align: 'left', width: 120 },
