...
export const PlanTableColumnDefaults = [
  { key: 'id', prop: 'planNumber', fixed: true, visible: true, align: 'center', width: 120 },
  { key: 'plan.name', prop: 'planName', fixed: true, visible: true, align: 'left', width: 240 },
  { key: 'plan.version', prop: 'planVersion', fixed: false, visible: true, align: 'center', width: 140 },
  ...
  { key: 'remark', prop: 'remark', fixed: false, visible: true, align: 'center' }
]
